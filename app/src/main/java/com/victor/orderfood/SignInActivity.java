...
//        }
    ...
    private void addControls() {
        ...
        etBirthday = (EditText) findViewById(R.id.txtdob);
        etPhoneNumber = (EditText) findViewById(R.id.txtphone);

        rdioMale = (RadioButton) findViewById(R.id.rNam);
        rdioFemale = (RadioButton) findViewById(R.id.rNu);

        //tvTitle = (TextView) findViewById(R.id.tv_title);
        rgGenre = (RadioGroup) findViewById(R.id.rGioiTinh);

        btConfirm = (Button) findViewById(R.id.btnRegis);
